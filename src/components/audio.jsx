    ...
    <>
      ...
      <div className="audio-section" style={{ backgroundColor: "rgb(255, 255, 255)" }}>
        ...
        <div className="audio-card">
          ...
          <p>
            لقة خفيفة بتحكي عن معنى البدء من جديد، وتهدّي القلق اللي جوّاك، وترجّعلك
      ...
      <div className="audio-section" style={{ backgroundColor: "rgb(255, 255, 255)" }}>
        <div className="audio-card">
          ...
          <p>
            حلقة ناعمة بتعلّمك خطوات بسيطة لتهدئة القلق، تهوية بالك، واسترجاع إحساس
        ...
        <div className="audio-card">
          ...
          <p>
            حلقة قصيرة تساعدك توقف دوامة التفكير، تهدّي قلقك، وترجع تسيطري على بالك
            بخطوات بسيطة ومريحة.
          </p>
          <audio controls>
        ...
        <div className="audio-card">
          ...
          <h3>ما فاتك شي</h3>
          <p>
            حلقة هادئة تطمّنك إنك ما تأخرت على شيء، وإن كل إشي إله وقته المناسب… كلام
            بسيط يخفّف عليك ويهدي بالك.
          </p>
          <audio controls>
            <source src="https://files.catbox.moe/malihy.mp3" type="audio/mpeg" />
          </audio>
        </div>
        ...
        <div className="audio-card">
          ...
          <p>
            حلقة تساعدك تفهمي خطوات التشافي بهدوء، وكيف تبدأي ترميم نفسك من جوّا بطريقة
            لطيفة وواقعية
          </p>
          <audio controls>
      ...
      <div className="audio-section" style={{ backgroundColor: "rgb(255, 255, 255)" }}>
        <div className="audio-card">
          ...
          <p>
            حلقة هادئة تطمّنك إن النهاية أحيانًا تكون بداية جديدة، وتهدي بالك بكلام
            بسيط ويدفي القلب
          </p>
          <audio controls>
        ...
        <div className="audio-card">
          ...
          <h3>أنا أشعر</h3>
          <p>
            حلقة خفيفة بتساعدك تفهمي مشاعرك وتسمّيها، وتهدّي داخلك بكلام بسيط ويريّح
            القلب
          </p>
          <audio controls>
        ...
        <div className="audio-card">
          ...
          <p>
            حلقة قصيرة بتساعدك ترجعي تَركّزي على ذاتك، وتقاومي الانسياق وراء الضغط
        ...
        <div className="audio-card">
          ...
          <p>
            حلقة رايقة بتحكي عن التعايش مع الخسائر، وكيف نتعامل معها بدون جلد، وبهدوء
